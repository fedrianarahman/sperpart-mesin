                                    ...
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            $query = mysqli_query($conn, "SELECT
                                             ...
                                             user.nama AS nama
                                             FROM pembelian_barang INNER JOIN user ON user.id = pembelian_barang.requester");
                                            $no = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="./detailPembelianBarang.php?id=<?php echo $data['id_pembelian']?>" class="btn btn-sm btn-warning"><i class="la la-eye text-white"></i></a>
                                                </td>
                                            </tr>
                                            <?php }?>
                                        </tbody>
