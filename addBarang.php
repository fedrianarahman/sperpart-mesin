...
<head>
    ...
    <style>
        .card-body-replica {
            ...
            align-items: center;
            /* Menengahkan vertikal (vertically center) */
            overflow: hidden;
        }
        ...
        .picture-replica img {
            ...
            display: block;
            margin: 0 auto;
            /* Menengahkan horizontal (horizontally center) */
        }
    </style>
</head>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    $kode_barang = $kd_brg;
                                                    ?>
                                                    <input type="text" name="kode_barang" value="<?php echo $kode_barang ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
